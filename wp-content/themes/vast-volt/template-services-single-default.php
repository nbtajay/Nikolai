<?php
/**
 * Template Name:  Template services single default
...
?>
  <!-- Page Title -->
    ...
    <section class="banner-section banner-style-three p_relative overflow-hidden">
        <div class="shape">
        ...
        <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
            <?php if( have_rows('services_slider_different') ): ?>
            <?php while( have_rows('services_slider_different') ): the_row(); ?>  
                <div class="slide-item p_relative pt_180">
                    <div class="image-layer p_absolute" style="background-image:url(<?php the_sub_field('services_slider_background_image'); ?>)"></div>
                    <div class="pattern-layer" style="background-image:url(<?php the_sub_field('services_slider_background_image_two'); ?>)"></div>
                    <div class="auto-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_block fs_60 lh_70 fw_bold mb_18"><?php the_sub_field('services_slider_head') ?></h2>
                            <p class="p_relative d_block fs_18"><?php the_sub_field('services_slider_banner_paragraph') ?></p>
                            <div class="btn-box">
                                <a href="<?php the_sub_field('services_slider_button_link'); ?>" class="theme-btn btn-one"><?php the_sub_field('services_slider_btn_text') ?>
                                </a>
                            </div>
                        </div> 
                    </div>
    ...
    <?php if(get_field('book_an_electrician_form_heading')): ?>
        <section class="search-field search-field-all">
            <div class="auto-container">
                <div class="outer-container">
                    <div class="title-text centred p_relative d_block">
                         <h6><?php the_field('book_an_electrician_form_heading') ?></h6>
                    </div>
...
<!-- chooseus-section -->
 ...
 <?php if(get_field('choose_included_list')): ?>
                                            ...
                                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 single-column">
                                                <div class="single-item">
                                                    <figure class="image-1 p_relative d_block">
                                                        <img src="<?php the_sub_field('choose_included_list_full_image'); ?>" alt="icon">
                                                    </figure>
                            ...
                            <div class="feature-block-one wow fadeInLeft" data-wow-duration="1500ms">
                                <div class="inner-box p_relative d_block clearfix">
                                    ...
                                    <div class="content-box p_relative d_block">
                                        ...
                                        <div class="link">
                                            <a href="<?php the_sub_field('feature_blocks_quote_link'); ?>">
                                                <span><?php the_sub_field('feature_blocks_quote_title'); ?></span><i class="icon-7"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
...
<!-- service-section -->
 ...
 <?php if(get_field('electrical_services_tabbing_content')): ?>
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12 image-column">
                                        <div class="image_block_two">
                                         ...
                                         <div class="image_block_two">
                                            <div class="image-box p_relative d_block mt_8">
                                                <figure class="image p_relative d_block">
                                                    <img src="<?php the_field('electrical_services_image_two'); ?>">
                                                </figure>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <?php while(has_sub_field('secuirty_services_tab_list')): ?>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                                                <div class="single-item p_relative d_block">
                                                                    ...
                                                                    <h4><a href="<?php the_sub_field('secuirty_services_link'); ?>"><?php the_sub_field('secuirty_services_head'); ?></a></h4>
                            ...
                            <?php while(has_sub_field('home_testimonial_slide')): ?>  
                                <div class="testimonial-block-one">
                                    <div class="inner-box p_relative d_block">
                                        <div class="light-icon"><img src="<?php bloginfo('template_url')?>/images/client-say-icon-3.png" alt=""></div>
                                        <div class="icon-box p_relative d_block fs_65">
                                            <img src="<?php bloginfo('template_url')?>/images/client_quotie.png" alt="">
                                        </div>
