...
$('ul.accordion-box li.accordion.block:first-child').addClass('active-block');
$('ul.accordion-box li.accordion.block:first-child .acc-btn').addClass('active');
$('ul.accordion-box li.accordion.block:first-child .acc-content').addClass('current');  
});
	...
	// five-item-carousel
	if ($('.five-item-carousels').length) {
		$('.five-item-carousels').owlCarousel({
			loop:true,
			margin:30,
			nav:true,
			smartSpeed: 500,
